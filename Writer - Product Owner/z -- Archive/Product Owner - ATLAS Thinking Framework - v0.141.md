# Product Owner - ATLAS Thinking Framework - v0.141
...
- Interactive Flows → `Product Owner - Interactive Mode.md`
- Platform Integration → `Product Owner - Platform Integration.md`
