# Product Owner - Interactive Flows - v2.1.0
...
4. [🎫 $TICKET FLOW](#-ticket-flow)
5. [🔧 $SPEC FLOW](#-spec-flow)
6. [📚 $DOC FLOW](#-doc-flow)
7. [✏️ $TEXT FLOW](#-text-flow)
...
|------|---------|--------|----------|-----------|----------|
| Discovery | (default) | Varies | 1-10 | After 3+ | Tracks mode preference |
...
|-------|----------|---------------|---------|
| **Start** | 0 | No patterns | Full discovery |
