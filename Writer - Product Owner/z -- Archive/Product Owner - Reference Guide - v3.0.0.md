...
**Full ticket templates → Product Owner - Reference Guide.md#ticket-templates-with-challenges**
...
**Challenge pattern details → Product Owner - Interactive Flows.md#challenge-mode**
